        ...
        <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
            ...
            <form method="POST" action="/login" class="form-login user space-y-4 md:space-y-6">
                ...
                <div>
                    ...
                    <input type="password" name="password" id="password" class="bg-gray-50 border border-gray-300 text-gray-900 
                ...
                <button type="submit" class="w-full text-white bg-emerald-600 hover:bg-emerald-700 focus:ring-4 focus:outline-none
